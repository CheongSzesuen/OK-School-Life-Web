...
const gameState = {
    ...
    achievements: [],
    score: 0,
    eventData: null, // 初始为null，将从外部加载
    version: "v0.4.0" // 默认版本号
};
...
function loadGameData() {
    return fetch(GAME_DATA_URL)
        ...
        .then(data => {
            ...
            gameState.version = data.metadata.version || gameState.version;
            return data;
        })
        .catch(error => {
            console.error('Error loading game data:', error);
